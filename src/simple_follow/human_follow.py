...
from simple_follow.wander_search import Wander, Search
from simple_follow.follow_and_move import Follow, MoveSearch
from simple_follow.local_search import LocalSearch
...
if __name__ == '__main__':
    rospy.init_node('simple_follow_sm')
    sm = SimpleFollow()
    rospy.spin()
